...
## Project workflow
Design notes live in an Obsidian vault, not the repo:
- Architecture: `~/Documents/Obsidian Vault/Projects/occt-wasm/occt-wasm-architecture.md`
- Tasks / decisions: same folder, `occt-wasm-tasks.md` / `occt-wasm-decisions.md`
- brepjs OCCT build reference: `~/Git/brepjs/packages/brepjs-opencascade/build-config/brepjs.yml`

Per the project's process: read the tasks doc first, record tasks/decisions as work lands, and keep the architecture doc honest when reality diverges.
